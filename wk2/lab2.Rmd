...
Unfortunately the configuration settings in Rstudio that you set in the [wk1/git](../wk1/git.html#configure-rstudio) do not seem to transfer between machines. The only setting you really need to apply is 
...
Based on the output countries from your script, produce a similar [map](../wk1/lab1.html#create-map-of-countries-wind-production) and markdown [report](../wk1/lab1.html#report-in-markdown) as lab1 but now for offshore wind and at `H:\esm296-4f\github\lab2\README.md` with:
...
When you [commit](../wk1/lab1.html#git-commit-and-push-from-rstudio) this README use the message to close your lab 2 issue (or visit the issue and close it seperately).
