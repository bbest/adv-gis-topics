...
Check out the open-source cross-platform equivalent code to accomplish this task in R in [wind_country.R](https://github.com/ucsb-bren/esm296-4f/blob/gh-pages/wk2/wind_country.R). Feel free to open it and try it out yourself. You'll need to run the [r_setup.R](https://github.com/ucsb-bren/esm296-4f/blob/gh-pages/wk2/r_setup.R) first. It also outputs plots to an img folder. If we have time I'll gove over the script in class.
...
You can look at a cleaned up version of the script [wind_country.py](https://github.com/ucsb-bren/esm296-4f/blob/gh-pages/wk2/wind_country.py).
